...
export function useActions() {
  return {
    ...
    updateResearch: useData((s) => s.updateResearch),
    deleteResearch: useData((s) => s.deleteResearch),
    convertResearch: useData((s) => s.convertResearch),
    addOption: useData((s) => s.addOption),
    updateOption: useData((s) => s.updateOption),
    deleteOption: useData((s) => s.deleteOption),
    addItineraryDay: useData((s) => s.addItineraryDay),
    updateItineraryDay: useData((s) => s.updateItineraryDay),
    deleteItineraryDay: useData((s) => s.deleteItineraryDay),
    addItineraryItem: useData((s) => s.addItineraryItem),
    updateItineraryItem: useData((s) => s.updateItineraryItem),
    deleteItineraryItem: useData((s) => s.deleteItineraryItem),
    moveItineraryItem: useData((s) => s.moveItineraryItem),
